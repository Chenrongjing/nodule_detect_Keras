...
DATA_FOLDER = './KAGGLE_NODULE_CROP_ALL_NPY_MG10/'
...
def generate_batch(data_list,  batch_size ):
    ...
    while True:
        ...
        yield batch_train_feature, batch_train_label
...
if __name__ == '__main__':
    ...
    callbacks = [
        ...
        history,
        ModelCheckpoint('Nodule_Nodule_Feature_FC_ND_NND.hdf5', monitor='val_loss', save_best_only=True, verbose=1),
