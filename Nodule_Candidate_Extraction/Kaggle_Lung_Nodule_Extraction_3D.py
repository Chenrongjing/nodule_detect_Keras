...
INPUT_FOLDER = '/home/kwanghee/LIDC/airi-demo-data/Kaggle/Data_Science_Bowl_2017/stage1/'
OUTPUT_FOLDER1 = '/home/kwanghee/LIDC/dsb2017/KAGGLE_NODULE_CROP_ALL_XY/'
OUTPUT_FOLDER2 = '/home/kwanghee/LIDC/dsb2017/KAGGLE_NODULE_CROP_ALL_YZ/'
OUTPUT_FOLDER3 = '/home/kwanghee/LIDC/dsb2017/KAGGLE_NODULE_CROP_ALL_ZX/'
OUTPUT_FOLDER4 = '/home/kwanghee/LIDC/dsb2017/KAGGLE_NODULE_CROP_ALL_NPY/'
    ...
    for i in xrange(0, np.shape(vol)[0],4):
        for j in xrange(0, np.shape(vol)[1],4):
            for k in xrange(0, np.shape(vol)[2],4):
                if temp_vol[i,j,k]>-1000 and temp_vol[i,j,k]<1000:
...
patients = []
CSV_R_PATH = '/home/kwanghee/LIDC/dsb2017/stage1_labels.csv'
CSV_W_PATH = '/home/kwanghee/LIDC/dsb2017/KAGGLE_Nodule_Param.csv'
